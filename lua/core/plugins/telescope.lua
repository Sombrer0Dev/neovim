...
local M = {
  ...
  keys = {
    ...
    { '<leader>sg', '<cmd>Telescope live_grep<cr>', desc = 'Search strings' },
    { '<leader>s?', '<cmd>Telescope help_tags<cr>', desc = 'Search help' },
    ...
    -- files
    { '<leader>sF', '<cmd>' .. require('utils.functions').project_files() .. '<cr>', desc = 'Search files (ignore git)' },
