...
return {
  hook = function(kb)
    local norg_utils = require("core.plugins.neorg.utils")
    kb.map("norg", "n", prefix .. "e", function()
    ...
    kb.map_event("norg", "n", prefix .. "c", "core.looking-glass.magnify-code-block")
    kb.map("norg", "n", prefix .. "q", "<Cmd>Neorg return<CR>")
